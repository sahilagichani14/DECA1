...
public class CHATest extends TestSetup {
	...
	private SootMethod observableNotifyObservers;
	private SootMethod observableNotifyObserversSpecific;
	...
	public void setUp() throws Exception {
		...
		observableNotifyObservers = scene.getMethod("<target.exercise1.Observable: void notifyObservers()>");
		observableNotifyObserversSpecific = scene.getMethod("<target.exercise1.Observable: void notifyObservers(java.lang.Object)>");
	...
	@Test public void instanceToInterfaceMethod() {
		...
		// more specific
		Set<SootMethod> calledFromNotify = cg.edgesOutOf(observableNotifyObservers);
	...
	public void polymorphicCallSite() {
		...
		Set<SootMethod> calledMethods = cg.edgesOutOf(observableNotifyObserversSpecific);
